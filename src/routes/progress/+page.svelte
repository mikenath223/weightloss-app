...
<section class="mx-3 my-10 md:mx-6">
	<h2 class="h2 font-extrabold">Weekly Progress Activity</h2>
	...
	<h2 class="h2 mt-10 font-extrabold">Rankings and Progress Status</h2>
	...
	<h2 class="h2 mt-10 font-extrabold">Group Performance</h2>
